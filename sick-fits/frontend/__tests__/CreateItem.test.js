...
// have to mock fetch because its a browser API
// this is returning what you would expect the fetch part of the uploadFile fn would do
// will work in other tests because its global
...
describe('<CreateItem/>', () => {
  ...
  it('uploads a file when changed', async () => {
    ...
    global.fetch.mockReset(); // reset global.fetch
  });
  ...
  it('creates an item when the form is submitted', async () => {
    ...
    const mocks = [
      {
        // when someone sends a request with the following info..
        request: {
        ...
        // ...this is what they will get back
        result: {
          data: {
            createItem: {
              ...item,
